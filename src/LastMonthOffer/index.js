...
export default () => (
  <Container>
    ...
    <GreetingText>Лучшие цены на авиабилеты за последний месяц</GreetingText>
    <DirectionList>
      <Direction>
        <DirectionInfo>
          <DirectionFlagRus />
        ...
        <DirectionDepartureList>
          ...
          <DirectionDepartureListCard>
            <DirectionDepartureCity>Из Санкт-Петербурга</DirectionDepartureCity>
            <DirectionDeparturePrice>от 7 857 ₽</DirectionDeparturePrice>
          </DirectionDepartureListCard>
          <DirectionDepartureListCard>
            <DirectionDepartureCity>Из Новосибирска</DirectionDepartureCity>
            <DirectionDeparturePrice>от 15 127 ₽</DirectionDeparturePrice>
          </DirectionDepartureListCard>
          <DirectionDepartureListCard>
            <DirectionDepartureCity>Из Екатеринбурга</DirectionDepartureCity>
      ...
      <Direction>
        ...
        <DirectionDepartureList>
          ...
          <DirectionDepartureListCard>
            <DirectionDepartureCity>Из Ростова-на-Дону</DirectionDepartureCity>
      ...
      <Direction>
        ...
        <DirectionDepartureList>
          ...
          <DirectionDepartureListCard>
            <DirectionDepartureCity>Из Нового Уренгоя</DirectionDepartureCity>
