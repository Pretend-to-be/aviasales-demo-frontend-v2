...
export default () => (
  <Container>
    ...
    <ChosenDirectionTypeProposal>
      <ChosenDirectionTypeProposalCity>
        <ChosenDirectionTypeProposalPicture src={pop_bg_1} alt="Krasnodar" />
        <ChosenDirectionTypeProposalContent>
          <ChosenDirectionTypeProposalOfferFlagRus />
          <ChosenDirectionTypeProposalCityInfo>
            <ChosenDirectionTypeProposalCityName>
      ...
      <ChosenDirectionTypeProposalCity>
        <ChosenDirectionTypeProposalPicture src={pop_bg_4} alt="Min. Vody" />
        <ChosenDirectionTypeProposalContent>
          <ChosenDirectionTypeProposalOfferFlagRus />
          <ChosenDirectionTypeProposalCityInfo>
            <ChosenDirectionTypeProposalCityName>
      ...
      <ChosenDirectionTypeProposalCity>
        <ChosenDirectionTypeProposalPicture src={pop_bg_5} alt="Simferopol" />
        <ChosenDirectionTypeProposalContent>
          <ChosenDirectionTypeProposalOfferFlagRus />
          <ChosenDirectionTypeProposalCityInfo>
            <ChosenDirectionTypeProposalCityName>
      ...
      <ChosenDirectionTypeProposalCity>
        <ChosenDirectionTypeProposalPicture src={pop_bg_6} alt="Barcelona" />
        <ChosenDirectionTypeProposalContent>
          <ChosenDirectionTypeProposalOfferFlagSpain />
          <ChosenDirectionTypeProposalCityInfo>
            <ChosenDirectionTypeProposalCityName>
