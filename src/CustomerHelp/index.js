...
import help_at from "./HelpAt.png";
import help_plane from "./HelpPlane.png";
import help_list from "./HelpList.png";

import { Container, Article, Label, Header, Text, More } from "./styled";

export default () => (
  <Container>
    <div className="container">
      <div className="row">
        <div className="col-xl-offset-1 col-xl-10 col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <Article>
            <Label src={help_plane} />
            <Header>КАК КУПИТЬ ДЕШЕВЫЕ АВИАБИЛЕТЫ?</Header>
            <Text>
          ...
          <Article>
            <Label src={help_at} />
            <Header>ЭЛЕКТРОННЫЙ АВИАБИЛЕТ</Header>
            <Text>
          ...
          <Article>
            <Label src={help_list} />
            <Header>20 СОВЕТОВ АВИАПУТЕШЕСТВЕННИКАМ</Header>
            <Text>
